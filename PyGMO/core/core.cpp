...
BOOST_PYTHON_MODULE(_core)
{
	...
	class_<population>("population", "Population class.", init<const problem::base &,optional<int> >())
        ...
        .def("get_crowding_d",&population::get_crowding_d, "Get crowding distance of individual.")
        .def("update_crowding_d", &population::update_crowding_d, "Updates the crowding distances of population.")
