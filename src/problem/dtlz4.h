...
#ifndef PAGMO_PROBLEM_DTLZ4_H
#define PAGMO_PROBLEM_DTLZ4_H
...
class __PAGMO_VISIBLE dtlz4 : public base_dtlz
{
	public:
		dtlz4(const size_t = 10, fitness_vector::size_type = 3, const size_t = 100);
...
BOOST_CLASS_EXPORT_KEY(pagmo::problem::dtlz4);

#endif // PAGMO_PROBLEM_DTLZ4_H
