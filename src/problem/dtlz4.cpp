...
/// Clone method.
base_ptr dtlz4::clone() const
{
	return base_ptr(new dtlz4(*this));
}

/// Implementation of the distance function g
double dtlz4::g_func(const decision_vector &x) const
{
	double y = 0.0;
...
void dtlz4::objfun_impl(fitness_vector &f, const decision_vector &x) const
{
...
std::string dtlz4::get_name() const
{
	return "DTLZ4";
}
}}

BOOST_CLASS_EXPORT_IMPLEMENT(pagmo::problem::dtlz4);
