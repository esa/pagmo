...
#ifndef PAGMO_PROBLEM_DTLZ2_H
#define PAGMO_PROBLEM_DTLZ2_H
...
/**
 *
 * This is a box-constrained continuous n-dimensional multi-objective problem, scalable in fitness dimension.
 *
...
BOOST_CLASS_EXPORT_KEY(pagmo::problem::dtlz2);

#endif // PAGMO_PROBLEM_DTLZ2_H
