...
/// Clone method.
base_ptr dtlz6::clone() const
{
	return base_ptr(new dtlz6(*this));
}

/// Implementation of the distance function g
double dtlz6::g_func(const decision_vector &x) const
{
	double y = 0.0;
...
std::string dtlz6::get_name() const
{
	return "DTLZ6";
}
}}

BOOST_CLASS_EXPORT_IMPLEMENT(pagmo::problem::dtlz6);
