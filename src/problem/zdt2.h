...
#ifndef PAGMO_PROBLEM_ZDT2_H
#define PAGMO_PROBLEM_ZDT2_H
...
class __PAGMO_VISIBLE zdt2 : public base_unc_mo
{
	public:
		zdt2(size_type = 30);
...
BOOST_CLASS_EXPORT_KEY(pagmo::problem::zdt2);

#endif // PAGMO_PROBLEM_ZDT2_H
