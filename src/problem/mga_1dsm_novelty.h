...
#ifndef PAGMO_PROBLEM_MGA_1DSM_NOVELTY_H
#define PAGMO_PROBLEM_MGA_1DSM_NOVELTY_H
 ...
 */
class __PAGMO_VISIBLE mga_1dsm_novelty: public base
{
	public:
		mga_1dsm_novelty(const std::vector<kep_toolbox::planet_ptr> = construct_default_sequence(), 
		...
		mga_1dsm_novelty(const mga_1dsm_novelty&);
...
BOOST_CLASS_EXPORT_KEY(pagmo::problem::mga_1dsm_novelty);
#endif // PAGMO_PROBLEM_MGA_1DSM_NOVELTY_H
