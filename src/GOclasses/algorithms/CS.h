...
class __PAGMO_VISIBLE CSalgorithm: public go_algorithm {
       public:
                ...
                */
              CSalgorithm(const double &minRange);
                 ...
                 * \param[in] minRange The algorithm stops when the range gets smaller than minRange. Has to be positive and smaller than one
                */
              CSalgorithm(const double &range, const double &reduxCoeff, const double &minRange);
              ...
              virtual CSalgorithm *clone() const {return new CSalgorithm(*this);}
