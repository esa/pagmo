 ...
 */
void nm_algorithm::check_bounds(vertex &v, const GOProblem &p) const
{
 ...
 */
nm_algorithm::vertex nm_algorithm::center_mass(const simplex &s) const
{
