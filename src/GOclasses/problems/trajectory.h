...
public:
	...
	*/
	cassini1();
	virtual cassini1 *clone() const {return new cassini1(*this);}
...
public:
	...
	*/
	gtoc1();
	virtual gtoc1 *clone() const {return new gtoc1(*this);}
	virtual std::string id_object() const {return id_name(); }
private:
	virtual double objfun_(const std::vector<double>&) const ;
...
public:
	messenger();
	virtual ~messenger() {}
	virtual messenger *clone() const {return new messenger(*this);}
	virtual std::string id_object() const {return id_name(); }
private:
	virtual double objfun_(const std::vector<double>&) const;
...
public:
	...
	virtual messengerfull *clone() const {return new messengerfull(*this);}
	virtual std::string id_object() const {return id_name(); }
private:
	virtual double objfun_(const std::vector<double>&) const;
	mgadsmproblem mgadsm;
...
public:
	...
	*/
	...
	virtual ~tandem() {}
	virtual tandem *clone() const {return new tandem(*this);}
	virtual std::string id_object() const {return id_name(); }
private:
...
public:
	cassini2();
	virtual ~cassini2() {}
	virtual cassini2 *clone() const {return new cassini2(*this);}
	virtual std::string id_object() const {return id_name(); }
private:
	virtual double objfun_(const std::vector<double>&) const;
	mgadsmproblem mgadsm;
...
public:
	rosetta();
	virtual ~rosetta() {}
	virtual rosetta *clone() const {return new rosetta(*this);}
	virtual std::string id_object() const {return id_name(); }
private:
	virtual double objfun_(const std::vector<double>&) const;
	mgadsmproblem mgadsm;
...
public:
	sagas();
	virtual ~sagas() {}
	virtual sagas *clone() const {return new sagas(*this);}
	virtual std::string id_object() const {return id_name(); }
private:
	virtual double objfun_(const std::vector<double>&) const;
	mgadsmproblem mgadsm;
...
public:
	...
	virtual ~laplace() {}
	virtual laplace *clone() const {return new laplace(*this);}
