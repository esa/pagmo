...
public:
        ...
        */
	rastrigin(int dim);
	virtual rastrigin *clone() const {return new rastrigin(*this);}
	virtual std::string id_object() const;
private:
	virtual double objfun_(const std::vector<double>& x) const { return rastriginf(x); }
};	//end class rastrigin
...
public:
        ...
        */
	schwefel(int dim);
	virtual schwefel *clone() const {return new schwefel(*this);}
	virtual std::string id_object() const;
private:
	virtual double objfun_(const std::vector<double>& x) const { return schwefelf(x); }
};	//end class schwefel
...
public:
        ...
        */
	ackley(int dim);
	virtual ackley *clone() const {return new ackley(*this);}
	virtual std::string id_object() const;
private:
	virtual double objfun_(const std::vector<double>& x) const { return ackleyf(x); }
};	//end class ackley
...
public:
        ...
        */
	rosenbrock(int dim);
	virtual rosenbrock* clone() const {return new rosenbrock(*this);}
	virtual std::string id_object() const;
private:
	virtual double objfun_(const std::vector<double>& x) const { return rosenbrockf(x); }
...
public:
	...
	virtual lennardjones *clone() const {return new lennardjones(*this);}
	virtual std::string id_object() const;
private:
	virtual double objfun_(const std::vector<double>& x) const { return lennardjonesf(x); }
...
public:
	...
	virtual std::string id_object() const;
private:
	virtual levy *clone() const {return new levy(*this);}
	virtual double objfun_(const std::vector<double>& x) const { return levyf(x); }
};	//end class levy
...
public:
        ...
        */
        ...
        virtual std::string id_object() const;
private:
        virtual griewank *clone() const {return new griewank(*this);}
        virtual double objfun_(const std::vector<double>& x) const { return griewankf(x); }
};	//end class griewank
