...
#ifndef PAGMO_ALGORITHM_JDE_ARCHIVED_H
#define PAGMO_ALGORITHM_JDE_ARCHIVED_H
...
/// jDE archived - Differential Evolution Algorithm - Self-Adaptive C and R (2011) extended with an archive
/**
 *
 ...
 *
 * This version of jDE uses an archive for previous solutions and is meant to be used as an EA for novelty search.
 *
...
class __PAGMO_VISIBLE jde_archived : public base
{
public:
...
BOOST_CLASS_EXPORT_KEY(pagmo::algorithm::jde_archived);

#endif // JDE_ARCHIVED_H
