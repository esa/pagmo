...
public:
	...
	pso_generational(int gen=1, double omega = 0.7298, double eta1 = 2.05, double eta2 = 2.05, double vcoeff = 0.5, int variant = 5, int neighb_type = 2, int neighb_param = 4, unsigned int nr_eval_per_x = 1, bool use_racing = false, unsigned int max_fevals = std::numeric_limits<unsigned int>::max());
