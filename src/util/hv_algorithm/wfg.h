...
class __PAGMO_VISIBLE wfg : public base {
	...
	private:
		inline std::vector<fitness_vector> limitset(const std::vector<fitness_vector> &, unsigned int) const;
		...
		inline double exclusive_hv(const std::vector<fitness_vector> &, unsigned int, const fitness_vector &) const;
