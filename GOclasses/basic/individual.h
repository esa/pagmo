...
public:
    //methods
	void createRandomIndividual(std::vector<double> LB, std::vector<double> UB, Pk::Random32& rng);
	...
	void resetVelocity(std::vector<double> LB, std::vector<double> UB, Pk::Random32& rng);
