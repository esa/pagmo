...
of optimisation problems and algorithms under the same common
...
are all automatically parallelized (asynchronously) thus making efficient use of the underlying multicore
architecture. The user can also program his own solvers ... they also will be parallelized by PyGMO!!
...
Efficient implementantions of bio-inspired algorithms (Particle Swarm optimization, Differential Evolution, Bee Colony
Search and many more ......) are sided to state-of the art optimization algorithms (Simplex Methods, SQP methods ....)
